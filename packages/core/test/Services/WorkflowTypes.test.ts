...
describe("WorkflowTypes", () => {
  ...
  describe("ExtractionRun", () => {
    it("should construct ExtractionRun with all fields", () => {
    ...
    it("should construct ExtractionRun with nullable fields as null", () => {
      const run = new ExtractionRun({
        run_id: "test-456",
        status: "running",
        status_version: 1,
  ...
  describe("RunCheckpoint", () => {
    it("should construct RunCheckpoint", () => {
  ...
  describe("RunArtifact", () => {
    it("should construct RunArtifact", () => {
  ...
  describe("BatchArtifact", () => {
    it("should construct BatchArtifact", () => {
  ...
  describe("CreateRunParams", () => {
    it("should construct CreateRunParams", () => {
  ...
  describe("ResumeRunParams", () => {
    it("should construct ResumeRunParams", () => {
